...
public final class TypeHandlerRegistry {
  ...
  /**
   * key -> JDBC 类型，value -> TypeHandler
   */
  private final Map<JdbcType, TypeHandler<?>> jdbcTypeHandlerMap = new EnumMap<>(JdbcType.class);

  /**
   * 类型处理器映射：key -> Java 类型，value -> JDBC 类型
   */
  ...
  /**
   * 所有的类型处理器：key -> 类型处理器类型，value -> 类型处理器
   */
  private final Map<Class<?>, TypeHandler<?>> allTypeHandlersMap = new HashMap<>();

  /**
   * 空Map，用来表示该 Java 类型没有对应的类型处理器
   */
   ...
   * 注册类型处理器
   *
   * @param javaType    Class类型
   * @param typeHandler 对应的类型处理器
   * @param <T>         T
   */
   ...
   * 注册类型处理器
   *
   * @param javaType    Type 类型
   * @param typeHandler 类型处理器
   * @param <T>         T
   */
  private <T> void register(Type javaType, TypeHandler<? extends T> typeHandler) {
    // 获取 javaType 要映射到的 JDBC 类型
