...
/**
 * {@code <resultMap/>} 中的 id、result、idArg、arg 节点都对应一个 ResultMapping
 *
...
public class ResultMapping {
  ...
  // 聚合的结果集映射，设置了 nestedQueryId 或 foreignColumn 时，会尝试解析 column
  // 如果 column 形如 {prop1=col1,prop2=col2} 的时候就会解析为 ResultMappings
