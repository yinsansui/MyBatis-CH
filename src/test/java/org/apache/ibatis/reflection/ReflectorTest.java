...
class ReflectorTest {
  ...
  class BridgeMethodTest implements SuperClass<String> {
  ...
  void testMethodReturnType() throws NoSuchMethodException {
    Method method = SuperClass.class.getDeclaredMethods()[0];
    Method method1 = BridgeMethodTest.class.getDeclaredMethods()[0];
    System.out.println(method.getDeclaringClass());
    System.out.println(method1.getDeclaringClass());

//    System.out.println(TypeParameterResolver.resolveReturnType(method, BridgeMethodTest.class));
  }
